...
//! ### Install Rust
//!
//! We recommend using the `vscode DevContainer` as your development environment.
//! You can find the setup instructions in the README file in the root of your
//! repo. All rust tools are already installed in the container. If you want to
//! install rust on your local machine, we recommend using the official
